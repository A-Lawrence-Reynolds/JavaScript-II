...
runnersLargeSizeShirt = runners.filter((shirt) => shirt.shirt_size === "L")
...
let largeDonations = [];
largeDonations = runners.filter((big$) => big$.donation > 100)
console.log(largeDonations);
// Problem 1
let companyName = [];
companyName = runners.map((compName) => compName.company_name).sort()
console.log(companyName);
// Problem 2
let howManyPeople = [];
howManyPeople = runners.length;
